...
本仓库的 IPK及APK 文件来自多个项目，版权归原作者，见 README 列表。

| 软件名称                  | 简介 / 功能描述                        | 来源 / 项目地址                                                                           |
| --------------------- | -------------------------------- | ----------------------------------------------------------------------------------- |
| luci-app-amlogic             | 晶晨宝盒(仅限ARM-64平台) | [amlogic](https://github.com/ophub/luci-app-amlogic)                       |
| luci-theme-aurora      | 极光主题                 | [aurora](https://github.com/eamonxg/luci-theme-aurora)                 |
| luci-app-bandix      | Bandix流量监控                 | [bandix](https://github.com/timsaya/luci-app-bandix)                 |
| luci-app-bandix-plus      | Bandix流量监控                 | [bandix-plus](https://github.com/timsaya/luci-app-bandix-plus)                 |
...
| luci-app-taskplan             | 任务计划 |[taskplan](https://github.com/sirpdboy/luci-app-taskplan)|
| luci-app-mosdns                | 高性能DNS       | [mosdns](https://github.com/sbwml/luci-app-mosdns)                     |
| luci-app-nekobox               | 代理工具      | [nekobox](https://github.com/Thaolga/openwrt-nekobox)       |
